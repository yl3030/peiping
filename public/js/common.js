...
//     }
// })
// $(".header_nav_drop_item").click(function(){
//     if($(window).width()<992){
//         $(this).find(".header_nav_seconddrop").slideToggle(300);
//     }
// })
$(window).on("resize scroll",function(){
    if($(window).width()<992){
...
$(".header_nav_titleM").click(function(){
    if($(window).width()<992){
        if($(this).hasClass("drop")){
            ...
            $(this).parents(".header_nav_item").siblings(".header_nav_item").find(".header_nav_drop").slideUp(300);
        }
    }
})
